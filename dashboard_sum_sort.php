...
//２．データ登録SQL作成
  ...
  $stmt = $pdo->prepare("SELECT innovation_tool.id, innovation_tool.problem, innovation_tool.solution, innovation_tool.age, innovation_tool.sex,innovation_tool.location,innovation_tool.user_id, SUM(cm_money) AS cnt FROM comment_table
